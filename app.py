...
st.text('Es una guía informativa para la población mexicana que muestra')
st.text('las bebidas saludables y la cantidad de líquidos que se recomienda consumir al día.')
