...
st.caption('Elaborado para la materia de programación por: Paulina Cano 335360, Valentina López 360890,')
st.caption('Luis Luna 355421 y Mariana Silva 355399 del grupo 4O. FCQ, UACH')
st.caption(' 18/11/2022')
